...
export const data: Data[] = [
  {
    id: 0,
    image: '/src/assets/a square image with a simple figure with white messenger pop ups all over.png',
    landscapeImage: '/src/assets/figurine-with-plenty-messages.png',
  ...
  {
    id: 1,
    image: '/src/assets/Create an image of a square image with a happy and positive vibe, figures of people in an office.png',
    landscapeImage: '/src/assets/happy-people-at-offoce-landscape.png',
